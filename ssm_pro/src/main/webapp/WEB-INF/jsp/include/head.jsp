...
<nav class="navbar navbar-inverse navbar-no-bg navbar-fixed-top" style=""
	role="navigation">
	<div class="container">
	<div class="btn-toolbar" style="position:absolute;left:40px;top:6px;">
		<a href="#menu-toggle" class="btn btn-inverse" id="menu-toggle"><i class="icon-align-justify icon-white"></i></a>
	</div>
